...
const DashboardOverview = () => {
  ...
  const chartData = [
    { name: 'Ebooks', value: 35, color: '#7C3AED' },
    { name: 'Articles', value: 25, color: '#A855F7' },
    { name: 'Videos', value: 15, color: '#C084FC' },
    { name: 'Templates', value: 10, color: '#DDD6FE' },
    { name: 'Graphics', value: 8, color: '#EDE9FE' },
    { name: 'Audio', value: 7, color: '#F3F4F6' },
  ];
